                        ...
                        VStack
                        {
                            ...
                            HStack
                            {
                                ...
                                }, label:
                                {
                                    ...
                                    .background(RoundedRectangle(cornerRadius: 20).foregroundColor(Color(red: 102/255, green: 0/255, blue: 204/255)))
                                })
                                ...
                                }, label:
                                {
                                    ...
                                    .padding(EdgeInsets(top: 5, leading: 5, bottom: 5, trailing:5))
                                    .background(RoundedRectangle(cornerRadius: 20).foregroundColor(Color(red: 0/255, green: 153/255, blue: 76/255)))
